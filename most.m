...
orange={'\n[\b',']\b\n'}; %this only works with fprintf, not with disp or sprintf %added by baraa
fprintf([orange{1},'You chose: most.build_model = false; most.solve_model = false; I will assume that a solved model exists in mdi.QP, and you want me to format & print it',orange{2}]); %line added by baraa
%   error('most: Ah ... are you sure you want to do nothing? (either ''most.build_model'' or ''most.solve_model'' must be true)'); % commented out by baraa
end
